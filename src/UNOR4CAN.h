...
//2024-11-16 AW
//--- added include to allow complete Cb
...
public:
  ...
  // (AW) add a method to register a Cb using the functor
	void set_callback(pfunction_holder *);
...
private:
  ...
  // (AW) store the functor of the object and Cb to be used
